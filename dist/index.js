...
class YoutubeDlp {
    ...
    getAudioStreamById(id_1) {
        return __awaiter(this, arguments, void 0, function* (id, format = "mp3") {
            try {
                if (!(0, check_regexp_1.checkVideoId)(id))
                    throw new Error("Invalid video id");
    ...
    getAudioStreamByHtml(htmlContent_1) {
        return __awaiter(this, arguments, void 0, function* (htmlContent, format = "mp3") {
            try {
                const video = yield this.getVideoByHtml(htmlContent);
                const stream = yield (0, downloader_1.fetchAudioStream)(video.formats[0].url, format);
                return { video, stream };
            }
            catch (e) {
    ...
    getVideoByHtml(htmlContent_1) {
        return __awaiter(this, arguments, void 0, function* (htmlContent, options = constants_1.defautlOptions) {
            try {
                const video = (0, exctractor_1.exctractVideoInfo)(htmlContent);
                const scripts = yield (0, desipher_1.extractFunctions)(htmlContent);
